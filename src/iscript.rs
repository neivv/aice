...
use crate::bw;
use crate::parse::{self, CodePosition, CodePos, Iscript};
            ...
            match opcode {
                ...
                ANIMATION_START => {
                    ...
                    match start_pos {
                        ...
                        None => return Err(self.pos as u32 - 1),
                    }
                }
                IF => {
...
impl SpriteOwnerMap {
    ...
    pub fn get_unit(&mut self, sprite: *mut bw::Sprite) -> Option<Unit> {
        unsafe {
            debug!("Get unit for sprite {:p} {:04x}", sprite, (*sprite).sprite_id);
