...
static FLINGY_VARS: &[(&[u8], FlingyVar)] = {
    ...
    &[
        ...
        (b"facing_direction", FacingDirectionDegrees),
        (b"movement_direction", MovementDirectionDegrees),
        (b"target_direction", TargetDirectionDegrees),
        (b"facing_direction_deg", FacingDirectionDegrees),
        (b"movement_direction_deg", MovementDirectionDegrees),
        (b"target_direction_deg", TargetDirectionDegrees),
        (b"facing_direction_bw", FacingDirectionBw),
        (b"movement_direction_bw", MovementDirectionBw),
        (b"target_direction_bw", TargetDirectionBw),
